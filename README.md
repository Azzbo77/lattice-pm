...
|---------|-------------|
| 1.5 | Full data backup / restore (JSON export + drag-and-drop import) |
...
- [x] **Full data backup / restore** — One-click export of entire app state as JSON. Import back in to restore or migrate. Warning about localStorage limits. Acts as poor-man's multi-device sync.
